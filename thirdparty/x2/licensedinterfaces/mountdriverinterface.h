...
public:
	...
	\param dRawRA is the right ascension coordinate of the mount from 0 to 24.
	\param dRawDec is the declination coordinate of the mount from -90 to +90. 
	\param bCached may be ignored. 
	\sa NeedsRefractionInterface for clarity on what is meant by "mechanical or raw" coordinates.*/
