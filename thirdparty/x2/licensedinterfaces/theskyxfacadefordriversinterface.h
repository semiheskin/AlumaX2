...
public:
	...
	Optional interfaces may perodically be added to TheSky and when they are the build number is provided in the respective documentation. 
	If your driver requires an optional interface that is only available after a given build, you can use the build() to react by either requiring a certian minimum build or gracefully degrading functionality. 
	*/
