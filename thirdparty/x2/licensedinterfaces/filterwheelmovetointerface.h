...
public:
	...
	virtual int									defaultFilterName(const int& nIndex, BasicStringInterface& strFilterNameOut){(void)nIndex; return 0;};
	...
	virtual void								embeddedFilterWheelInit(const char* psFilterWheelSelection){(void)psFilterWheelSelection;}
