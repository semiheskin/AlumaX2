...
public:
	...
	virtual void			setDataBits(const int& nValue){(void)nValue;}
	/*!Return if the parameter is fixed or not.  The general user interface will hide this parameter if it is fixed.*/
	...
	virtual void			setStopBits(const int& nValue){(void)nValue;}
	/*!Return if the parameter is fixed or not.  The general user interface will hide this parameter if it is fixed.*/
	...
	virtual void			setFlowControl(const int& nValue){(void)nValue;}
	/*!Return if the parameter is fixed or not.  The general user interface will hide this parameter if it is fixed.*/
